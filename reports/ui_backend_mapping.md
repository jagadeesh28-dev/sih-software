...
- **Source File**: [`src/qi_prediction/serving.py`](../src/qi_prediction/serving.py#L225)
...
- **Source File**: [`src/qi_prediction/serving.py`](../src/qi_prediction/serving.py#L348) loading [`models/model_real_04.txt`](../models/model_real_04.txt)
...
- **Source File**: [`src/qi_prediction/serving.py`](../src/qi_prediction/serving.py#L325) loading [`models/qi_c1.txt`](../models/qi_c1.txt)
...
- **Source File**: [`src/qi_prediction/serving.py`](../src/qi_prediction/serving.py#L336) loading [`models/qi_c1_vessel_type.txt`](../models/qi_c1_vessel_type.txt)
...
- **Source File**: [`src/qi_prediction/serving.py`](../src/qi_prediction/serving.py#L415) loading [`models/conformal_quantiles.json`](../models/conformal_quantiles.json)
...
- **Source File**: [`src/qi_prediction/serving.py`](../src/qi_prediction/serving.py#L202) loading [`models/domain_checker.json`](../models/domain_checker.json)
...
- **Source File**: [`src/qi_prediction/serving.py`](../src/qi_prediction/serving.py#L371)
...
- **Source File**: [`optimization/canonical_mapper.py`](../optimization/canonical_mapper.py#L75)
...
- **Source File**: [`optimization/sih_objective_engine.py`](../optimization/sih_objective_engine.py#L138) & [`optimization/cost_model.py`](../optimization/cost_model.py)
...
- **Source File**: [`optimization/sih_objective_engine.py`](../optimization/sih_objective_engine.py#L173) & [`optimization/emissions_model.py`](../optimization/emissions_model.py)
...
- **Source File**: [`lca/fuel_registry.py`](../lca/fuel_registry.py) loading [`configs/fuels.yaml`](../configs/fuels.yaml)
...
- **Source File**: [`optimization/sih_objective_engine.py`](../optimization/sih_objective_engine.py#L183) & [`configs/fuels.yaml`](../configs/fuels.yaml#L95)
...
- **Source File**: [`optimization/sih_objective_engine.py`](../optimization/sih_objective_engine.py) & [`results/algorithm_multiobjective_results.csv`](../results/algorithm_multiobjective_results.csv)
...
- **Source File**: [`results/pareto_front.csv`](../results/pareto_front.csv) & [`results/multiobjective_tradeoffs.csv`](../results/multiobjective_tradeoffs.csv)
...
- **Source File**: [`scripts/demo_scenarios.py`](../scripts/demo_scenarios.py)
